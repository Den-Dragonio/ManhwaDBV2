 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function to(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.href)||""}function Dp(){return Ll()==="http:"||Ll()==="https:"}function Ll(){var n;return typeof self<"u"&&((n=self.location)===null||n===void 0?void 0:n.protocol)||null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function pr(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function $p(n,e=!1){const t=ne(n),r=await t.getIdToken(e),s=xo(r);U(s&&s.exp&&s.auth_time&&s.iat,t.auth,"internal-error");const i=typeof s.firebase=="object"?s.firebase:void 0,a=i==null?void 0:i.sign_in_provider;return{claims:s,token:r,authTime:pr(ji(s.auth_time)),issuedAtTime:pr(ji(s.iat)),expirationTime:pr(ji(s.exp)),signInProvider:a||null,signInSecondFactor:(i==null?void 0:i.sign_in_second_factor)||null}}function ji(n){return Number(n)*1e3}function xo(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return gs("JWT malformed, contained fewer than 3 sections"),null;try{const s=Wc(t);return s?JSON.parse(s):(gs("Failed to decode base64 JWT payload"),null)}catch(s){return gs("Caught error parsing JWT payload as JSON",s==null?void 0:s.toString()),null}}function Ml(n){const e=xo(n);return U(e,"internal-error"),U(typeof e.exp<"u","internal-error"),U(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bl(n){const e=n.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(pu(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(hu(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(gu(e))return"Blackberry";if(_u(e))return"Webos";if(du(e))return"Safari";if((e.includes("chrome/")||fu(e))&&!e.includes("edge/"))return"Chrome";if(mu(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=n.match(t);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function hu(n=Se()){return/firefox\//i.test(n)}function du(n=Se()){const e=n.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function fu(n=Se()){return/crios\//i.test(n)}function pu(n=Se()){return/iemobile/i.test(n)}function mu(n=Se()){return/android/i.test(n)}function gu(n=Se()){return/blackberry/i.test(n)}function _u(n=Se()){return/webos/i.test(n)}function Lo(n=Se()){return/iphone|ipad|ipod/i.test(n)||/macintosh/i.test(n)&&/mobile/i.test(n)}function Gp(n=Se()){var e;return Lo(n)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function Qp(){return hf()&&document.documentMode===10}function yu(n=Se()){return Lo(n)||mu(n)||_u(n)||gu(n)||/windows phone/i.test(n)||pu(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class zu{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}class Kg{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){e.enqueueRetryable(()=>t(be.UNAUTHENTICATED))}shutdown(){}}class Gg{constructor(e){this.token=e,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(e,t){this.changeListener=t,e.enqueueRetryable(()=>t(this.token.user))}shutdown(){this.changeListener=null}}class Qg{constructor(e){this.t=e,this.currentUser=be.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(e,t){J(this.o===void 0);let r=this.i;const s=u=>this.i!==r?(r=this.i,t(u)):Promise.resolve();let i=new at;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new at,e.enqueueRetryable(()=>s(this.currentUser))};const a=()=>{const u=i;e.enqueueRetryable(async()=>{await u.promise,await s(this.currentUser)})},l=u=>{L("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),a())};this.t.onInit(u=>l(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(L("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new at)}},0),a()}getToken(){const e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(r=>this.i!==e?(L("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):r?(J(typeof r.accessToken=="string"),new zu(r.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const e=this.auth&&this.auth.getUid();return J(e===null||typeof e=="string"),new be(e)}}class Yg{constructor(e,t,r){this.l=e,this.h=t,this.P=r,this.type="FirstParty",this.user=be.FIRST_PARTY,this.I=new Map}T(){return this.P?this.P():null}get headers(){this.I.set("X-Goog-AuthUser",this.l);const e=this.T();return e&&this.I.set("Authorization",e),this.h&&this.I.set("X-Goog-Iam-Authorization-Token",this.h),this.I}}class Jg{constructor(e,t,r){this.l=e,this.h=t,this.P=r}getToken(){return Promise.resolve(new Yg(this.l,this.h,this.P))}start(e,t){e.enqueueRetryable(()=>t(be.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Xg{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Zg{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){J(this.o===void 0);const r=i=>{i.error!=null&&L("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const a=i.token!==this.R;return this.R=i.token,L("FirebaseAppCheckTokenProvider",`Received ${a?"new":"existing"} token.`),a?t(i.token):Promise.resolve()};this.o=i=>{e.enqueueRetryable(()=>r(i))};const s=i=>{L("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.A.onInit(i=>s(i)),setTimeout(()=>{if(!this.appCheck){const i=this.A.getImmediate({optional:!0});i?s(i):L("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){const e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(t=>t?(J(typeof t.token=="string"),this.R=t.token,new Xg(t.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vr(n){if(n.code!==P.FAILED_PRECONDITION||n.message!==i_)throw n;L("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(e){this.binaryString=e}static fromBase64String(e){const t=function(s){try{return atob(s)}catch(i){throw typeof DOMException<"u"&&i instanceof DOMException?new Ku("Invalid base64 string: "+i):i}}(e);return new _e(t)}static fromUint8Array(e){const t=function(s){let i="";for(let a=0;a<s.length;++a)i+=String.fromCharCode(s[a]);return i}(e);return new _e(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return function(t){return btoa(t)}(this.binaryString)}toUint8Array(){return function(t){const r=new Uint8Array(t.length);for(let s=0;s<t.length;s++)r[s]=t.charCodeAt(s);return r}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return Y(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}_e.EMPTY_BYTE_STRING=new _e("");const c_=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function xt(n){if(J(!!n),typeof n=="string"){let e=0;const t=c_.exec(n);if(J(!!t),t[1]){let s=t[1];s=(s+"000000000").substr(0,9),e=Number(s)}const r=new Date(n);return{seconds:Math.floor(r.getTime()/1e3),nanos:e}}return{seconds:oe(n.seconds),nanos:oe(n.nanos)}}function oe(n){return typeof n=="number"?n:typeof n=="string"?Number(n):0}function en(n){return typeof n=="string"?_e.fromBase64String(n):_e.fromUint8Array(n)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qo(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{}).__type__)===null||t===void 0?void 0:t.stringValue)==="server_timestamp"}function jo(n){const e=n.mapValue.fields.__previous_value__;return qo(e)?jo(e):e}function Ir(n){const e=xt(n.mapValue.fields.__local_write_time__.timestampValue);return new ae(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Go(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ls(e)?"-0":e}}function ah(n){return{integerValue:""+n}}function V_(n,e){return l_(e)?ah(e):Go(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class by{constructor(e,t){this.qr={},this.overlays={},this.Qr=new $o(0),this.Kr=!1,this.Kr=!0,this.$r=new vy,this.referenceDelegate=e(this),this.Ur=new Ty(this),this.indexManager=new dy,this.remoteDocumentCache=function(s){return new Ey(s)}(r=>this.referenceDelegate.Wr(r)),this.serializer=new uy(t),this.Gr=new _y(this.serializer)}start(){return Promise.resolve()}shutdown(){return this.Kr=!1,Promise.resolve()}get started(){return this.Kr}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(e){return this.indexManager}getDocumentOverlayCache(e){let t=this.overlays[e.toKey()];return t||(t=new yy,this.overlays[e.toKey()]=t),t}getMutationQueue(e,t){let r=this.qr[e.toKey()];return r||(r=new wy(t,this.referenceDelegate),this.qr[e.toKey()]=r),r}getGlobalsCache(){return this.$r}getTargetCache(){return this.Ur}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Gr}runTransaction(e,t,r){L("MemoryPersistence","Starting transaction:",e);const s=new Ay(this.Qr.next());return this.referenceDelegate.zr(),r(s).next(i=>this.referenceDelegate.jr(s).next(()=>i)).toPromise().then(i=>(s.raiseOnCommittedEvent(),i))}Hr(e,t){return C.or(Object.values(this.qr).map(r=>()=>r.containsKey(e,t)))}}class Ay extends o_{constructor(e){super(),this.currentSequenceNumber=e}}class Zo{constructor(e){this.persistence=e,this.Jr=new Xo,this.Yr=null}static Zr(e){return new Zo(e)}get Xr(){if(this.Yr)return this.Yr;throw B()}addReference(e,t,r){return this.Jr.addReference(r,t),this.Xr.delete(r.toString()),C.resolve()}removeReference(e,t,r){return this.Jr.removeReference(r,t),this.Xr.add(r.toString()),C.resolve()}markPotentiallyOrphaned(e,t){return this.Xr.add(t.toString()),C.resolve()}removeTarget(e,t){this.Jr.gr(t.targetId).forEach(s=>this.Xr.add(s.toString()));const r=this.persistence.getTargetCache();return r.getMatchingKeysForTargetId(e,t.targetId).next(s=>{s.forEach(i=>this.Xr.add(i.toString()))}).next(()=>r.removeTargetData(e,t))}zr(){this.Yr=new Set}jr(e){const t=this.persistence.getRemoteDocumentCache().newChangeBuffer();return C.forEach(this.Xr,r=>{const s=O.fromPath(r);return this.ei(e,s).next(i=>{i||t.removeEntry(s,$.min())})}).next(()=>(this.Yr=null,t.apply(e)))}updateLimboDocument(e,t){return this.ei(e,t).next(r=>{r?this.Xr.delete(t.toString()):this.Xr.add(t.toString())})}Wr(e){return 0}ei(e,t){return C.or([()=>C.resolve(this.Jr.containsKey(t)),()=>this.persistence.getTargetCache().containsKey(e,t),()=>this.persistence.Hr(e,t)])}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sy{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=function(){return df()?8:a_(Se())>0?6:4}()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.Yi(e,t).next(a=>{i.result=a}).next(()=>{if(!i.result)return this.Zi(e,t,s,r).next(a=>{i.result=a})}).next(()=>{if(i.result)return;const a=new Ry;return this.Xi(e,t,a).next(l=>{if(i.result=l,this.zi)return this.es(e,t,a,l.size)})}).next(()=>i.result)}es(e,t,r,s){return r.documentReadCount<this.ji?(or()<=K.DEBUG&&L("QueryEngine","SDK will not create cache indexes for query:",fn(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),C.resolve()):(or()<=K.DEBUG&&L("QueryEngine","Query:",fn(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.Hi*s?(or()<=K.DEBUG&&L("QueryEngine","The SDK decides to create cache indexes for query:",fn(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Ye(t))):C.resolve())}Yi(e,t){if(dc(t))return C.resolve(null);let r=Ye(t);return this.indexManager.getIndexType(e,r).next(s=>s===0?null:(t.limit!==null&&s===1&&(t=Ms(t,null,"F"),r=Ye(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next(i=>{const a=W(...i);return this.Ji.getDocuments(e,a).next(l=>this.indexManager.getMinOffset(e,r).next(u=>{const d=this.ts(t,l);return this.ns(t,d,a,u.readTime)?this.Yi(e,Ms(t,null,"F")):this.rs(e,d,t,u)}))})))}Zi(e,t,r,s){return dc(t)||s.isEqual($.min())?C.resolve(null):this.Ji.getDocuments(e,r).next(i=>{const a=this.ts(t,i);return this.ns(t,a,r,s)?C.resolve(null):(or()<=K.DEBUG&&L("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),fn(t)),this.rs(e,a,t,n_(s,-1)).next(l=>l))})}ts(e,t){let r=new ge(rh(e));return t.forEach((s,i)=>{Xs(e,i)&&(r=r.add(i))}),r}ns(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}Xi(e,t,r){return or()<=K.DEBUG&&L("QueryEngine","Using full collection scan to execute query:",fn(t)),this.Ji.getDocumentsMatchingQuery(e,t,Nt.min(),r)}rs(e,t,r,s){return this.Ji.getDocumentsMatchingQuery(e,r,s).next(i=>(t.forEach(a=>{i=i.insert(a.key,a)}),i))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ac{constructor(){this.ao=()=>this.uo(),this.co=()=>this.lo(),this.ho=[],this.Po()}_o(e){this.ho.push(e)}shutdown(){window.removeEventListener("online",this.ao),window.removeEventListener("offline",this.co)}Po(){window.addEventListener("online",this.ao),window.addEventListener("offline",this.co)}uo(){L("ConnectivityMonitor","Network connectivity changed: AVAILABLE");for(const e of this.ho)e(0)}lo(){L("ConnectivityMonitor","Network connectivity changed: UNAVAILABLE");for(const e of this.ho)e(1)}static D(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Te="WebChannelConnection";class By extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const r=t.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Do=r+"://"+t.host,this.vo=`projects/${s}/databases/${i}`,this.Co=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get Fo(){return!1}Mo(t,r,s,i,a){const l=Wi(),u=this.xo(t,r.toUriEncodedString());L("RestConnection",`Sending RPC '${t}' ${l}:`,u,s);const d={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(d,i,a),this.No(t,u,d,s).then(p=>(L("RestConnection",`Received RPC '${t}' ${l}: `,p),p),p=>{throw Sn("RestConnection",`RPC '${t}' ${l} failed with error: `,p,"url: ",u,"request:",s),p})}Lo(t,r,s,i,a,l){return this.Mo(t,r,s,i,a)}Oo(t,r,s){t["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Un}(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,a)=>t[a]=i),s&&s.headers.forEach((i,a)=>t[a]=i)}xo(t,r){const s=Uy[t];return`${this.Do}/v1/${r}:${s}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,r,s){const i=Wi();return new Promise((a,l)=>{const u=new Fu;u.setWithCredentials(!0),u.listenOnce(Bu.COMPLETE,()=>{try{switch(u.getLastErrorCode()){case ws.NO_ERROR:const p=u.getResponseJson();L(Te,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(p)),a(p);break;case ws.TIMEOUT:L(Te,`RPC '${e}' ${i} timed out`),l(new N(P.DEADLINE_EXCEEDED,"Request time out"));break;case ws.HTTP_ERROR:const g=u.getStatus();if(L(Te,`RPC '${e}' ${i} failed with status:`,g,"response text:",u.getResponseText()),g>0){let T=u.getResponseJson();Array.isArray(T)&&(T=T[0]);const w=T==null?void 0:T.error;if(w&&w.status&&w.message){const S=function(k){const x=k.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(x)>=0?x:P.UNKNOWN}(w.status);l(new N(S,w.message))}else l(new N(P.UNKNOWN,"Server responded with status "+u.getStatus()))}else l(new N(P.UNAVAILABLE,"Connection failed."));break;default:B()}}finally{L(Te,`RPC '${e}' ${i} completed.`)}});const d=JSON.stringify(s);L(Te,`RPC '${e}' ${i} sending request:`,s),u.send(t,"POST",d,r,15)})}Bo(e,t,r){const s=Wi(),i=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],a=ju(),l=qu(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(u.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(u.useFetchStreams=!0),this.Oo(u.initMessageHeaders,t,r),u.encodeInitMessageHeaders=!0;const p=i.join("");L(Te,`Creating RPC '${e}' stream ${s}: ${p}`,u);const g=a.createWebChannel(p,u);let T=!1,w=!1;const S=new Fy({Io:k=>{w?L(Te,`Not sending because RPC '${e}' stream ${s} is closed:`,k):(T||(L(Te,`Opening RPC '${e}' stream ${s} transport.`),g.open(),T=!0),L(Te,`RPC '${e}' stream ${s} sending:`,k),g.send(k))},To:()=>g.close()}),D=(k,x,F)=>{k.listen(x,M=>{try{F(M)}catch(z){setTimeout(()=>{throw z},0)}})};return D(g,cr.EventType.OPEN,()=>{w||(L(Te,`RPC '${e}' stream ${s} transport opened.`),S.yo())}),D(g,cr.EventType.CLOSE,()=>{w||(w=!0,L(Te,`RPC '${e}' stream ${s} transport closed`),S.So())}),D(g,cr.EventType.ERROR,k=>{w||(w=!0,Sn(Te,`RPC '${e}' stream ${s} transport errored:`,k),S.So(new N(P.UNAVAILABLE,"The operation could not be completed")))}),D(g,cr.EventType.MESSAGE,k=>{var x;if(!w){const F=k.data[0];J(!!F);const M=F,z=M.error||((x=M[0])===null||x===void 0?void 0:x.error);if(z){L(Te,`RPC '${e}' stream ${s} received error:`,z);const ye=z.status;let te=function(_){const v=le[_];if(v!==void 0)return mh(v)}(ye),E=z.message;te===void 0&&(te=P.INTERNAL,E="Unknown error status: "+ye+" with message "+z.message),w=!0,S.So(new N(te,E)),g.close()}else L(Te,`RPC '${e}' stream ${s} received:`,F),S.bo(F)}}),D(l,$u.STAT_EVENT,k=>{k.stat===io.PROXY?L(Te,`RPC '${e}' stream ${s} detected buffering proxy`):k.stat===io.NOPROXY&&L(Te,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{S.wo()},0),S}}function Ki(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sc{constructor(){this.W_=new re(O.comparator)}track(e){const t=e.doc.key,r=this.W_.get(t);r?e.type!==0&&r.type===3?this.W_=this.W_.insert(t,e):e.type===3&&r.type!==1?this.W_=this.W_.insert(t,{type:r.type,doc:e.doc}):e.type===2&&r.type===2?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):e.type===2&&r.type===0?this.W_=this.W_.insert(t,{type:0,doc:e.doc}):e.type===1&&r.type===0?this.W_=this.W_.remove(t):e.type===1&&r.type===2?this.W_=this.W_.insert(t,{type:1,doc:r.doc}):e.type===0&&r.type===1?this.W_=this.W_.insert(t,{type:2,doc:e.doc}):B():this.W_=this.W_.insert(t,e)}G_(){const e=[];return this.W_.inorderTraversal((t,r)=>{e.push(r)}),e}}class xn{constructor(e,t,r,s,i,a,l,u,d){this.query=e,this.docs=t,this.oldDocs=r,this.docChanges=s,this.mutatedKeys=i,this.fromCache=a,this.syncStateChanged=l,this.excludesMetadataChanges=u,this.hasCachedResults=d}static fromInitialDocuments(e,t,r,s,i){const a=[];return t.forEach(l=>{a.push({type:0,doc:l})}),new xn(e,t,Tn.emptySet(t),a,r,s,!0,!1,i)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Js(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,r=e.docChanges;if(t.length!==r.length)return!1;for(let s=0;s<t.length;s++)if(t[s].type!==r[s].type||!t[s].doc.isEqual(r[s].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function cd(n){return li(n=Fe(n,Bt)),new Wv(n,e=>qr(n,e))}(function(e,t=!0){(function(s){Un=s})(Mn),An(new Yt("firestore",(r,{instanceIdentifier:s,options:i})=>{const a=r.getProvider("app").getImmediate(),l=new Bt(new Qg(r.getProvider("auth-internal")),new Zg(r.getProvider("app-check-internal")),function(d,p){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new N(P.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Tr(d.options.projectId,p)}(a,s),a);return i=Object.assign({useFetchStreams:t},i),l._setSettings(i),l},"PUBLIC").setMultipleInstances(!0)),Pt(tc,"4.7.3",e),Pt(tc,"4.7.3","esm2017")})();const Kv={apiKey:"AIzaSyCSdbVzlGYazn9zJH8ee55jJwNAioZg7m8",authDomain:"manhwadb-9319f.firebaseapp.com",projectId:"manhwadb-9319f",storageBucket:"manhwadb-9319f.firebasestorage.app",messagingSenderId:"647854568421",appId:"1:647854568421:web:802c4cf20e69264e9b350c"},ud=Xc(Kv),$t=jg(ud),H=Dv(ud);function Gv(n){return n?n instanceof ae?n.toDate().toISOString():n!=null&&n.seconds?new Date(n.seconds*1e3).toISOString():n:null}function fi(n){if(!n.exists())return null;const e=n.data();return Object.keys(e).forEach(t=>{var r;(e[t]instanceof ae||(r=e[t])!=null&&r.seconds)&&(e[t]=Gv(e[t]))}),{id:n.id,...e}}function Dt(n){return n.docs.map(e=>fi(e))}let As=null;const Re={get:()=>{var n;return((n=$t.currentUser)==null?void 0:n.uid)||null},currentUser:()=>As,setProfile:n=>{As=n},clear:()=>{As=null}},ue={byId:async n=>{if(!n)return null;const e=await Xe(ie(H,"users",n));return fi(e)},byUsername:async n=>{const e=await Xe(ie(H,"usernames",n.toLowerCase()));if(!e.exists())return null;const{uid:t}=e.data();return ue.byId(t)},save:async n=>{var r;const{id:e,...t}=n;await zs(ie(H,"users",e),t,{merge:!0}),((r=$t.currentUser)==null?void 0:r.uid)===e&&Re.setProfile({...As||{},...t,id:e})},delete:async n=>{await $r(ie(H,"users",n))}},Ue={all:async()=>{const n=await We(Oe(H,"reviews"));return Dt(n).sort((e,t)=>new Date(t.createdAt)-new Date(e.createdAt))},byId:async n=>{const e=await Xe(ie(H,"reviews",n));return fi(e)},byUser:async n=>{const e=kt(Oe(H,"reviews"),je("userId","==",n)),t=await We(e);return Dt(t).sort((r,s)=>new Date(s.createdAt)-new Date(r.createdAt))},topRated:async(n=10)=>{const e=await We(kt(Oe(H,"reviews"),Bv("createdAt","desc"),$v(200)));return Dt(e).sort((t,r)=>r.rating-t.rating).slice(0,n)},create:async(n,e)=>{const t=Re.currentUser();return{id:(await Ia(Oe(H,"reviews"),{userId:n,username:(t==null?void 0:t.username)||"Unknown",title:e.title||"",coverBase64:e.coverBase64||"",text:e.text||"",rating:e.rating??0,status:e.status||"done",tags:e.tags||[],date:e.date||"",likes:[],dislikes:[],createdAt:new Date().toISOString(),updatedAt:null})).id,userId:n,...e}},update:async(n,e)=>(await ze(ie(H,"reviews",n),{...e,updatedAt:new Date().toISOString()}),{id:n,...e}),delete:async n=>{await $r(ie(H,"reviews",n));const e=await We(kt(Oe(H,"comments"),je("reviewId","==",n))),t=cd(H);e.docs.forEach(r=>t.delete(r.ref)),await t.commit()},toggleLike:async(n,e)=>{const t=ie(H,"reviews",n),r=await Xe(t);if(!r.exists())return;const{likes:s=[],dislikes:i=[]}=r.data();s.includes(e)?await ze(t,{likes:At(e)}):await ze(t,{likes:Hs(e),dislikes:At(e)})},toggleDislike:async(n,e)=>{const t=ie(H,"reviews",n),r=await Xe(t);if(!r.exists())return;const{likes:s=[],dislikes:i=[]}=r.data();i.includes(e)?await ze(t,{dislikes:At(e)}):await ze(t,{dislikes:Hs(e),likes:At(e)})}},gn={byReview:async n=>{const e=kt(Oe(H,"comments"),je("reviewId","==",n)),t=await We(e);return Dt(t).sort((r,s)=>new Date(r.createdAt)-new Date(s.createdAt))},create:async(n,e,t,r=null)=>{const s=Re.currentUser();return{id:(await Ia(Oe(H,"comments"),{reviewId:n,userId:e,username:(s==null?void 0:s.username)||"Unknown",avatarBase64:(s==null?void 0:s.avatarBase64)||"",text:t,parentId:r,likes:[],dislikes:[],createdAt:new Date().toISOString(),updatedAt:null})).id,reviewId:n,userId:e,text:t,parentId:r}},delete:async n=>{await $r(ie(H,"comments",n));const e=await We(kt(Oe(H,"comments"),je("parentId","==",n))),t=cd(H);e.docs.forEach(r=>t.delete(r.ref)),await t.commit()},toggleLike:async(n,e)=>{var s;const t=ie(H,"comments",n),r=await Xe(t);r.exists()&&((s=r.data().likes)!=null&&s.includes(e)?await ze(t,{likes:At(e)}):await ze(t,{likes:Hs(e),dislikes:At(e)}))},toggleDislike:async(n,e)=>{var s;const t=ie(H,"comments",n),r=await Xe(t);r.exists()&&((s=r.data().dislikes)!=null&&s.includes(e)?await ze(t,{dislikes:At(e)}):await ze(t,{dislikes:Hs(e),likes:At(e)}))}};function fs(n,e){return[n,e].sort().join("_")}const Le={between:async(n,e)=>{const t=await Xe(ie(H,"friends",fs(n,e)));return fi(t)},ofUser:async n=>{const e=kt(Oe(H,"friends"),je("users","array-contains",n),je("status","==","accepted")),t=await We(e);return Dt(t)},pendingFor:async n=>{const e=kt(Oe(H,"friends"),je("receiverId","==",n),je("status","==","pending")),t=await We(e);return Dt(t)},sentBy:async n=>{const e=kt(Oe(H,"friends"),je("requesterId","==",n),je("status","==","pending")),t=await We(e);return Dt(t)},send:async(n,e)=>{if(await Le.between(n,e))return!1;const r=fs(n,e);return await zs(ie(H,"friends",r),{users:[n,e],requesterId:n,receiverId:e,status:"pending",createdAt:new Date().toISOString()}),!0},accept:async(n,e)=>{await ze(ie(H,"friends",fs(n,e)),{status:"accepted"})},remove:async(n,e)=>{await $r(ie(H,"friends",fs(n,e)))}},nn={recent:async(n=40)=>{const e=await We(Oe(H,"news"));return Dt(e).sort((t,r)=>new Date(r.createdAt)-new Date(t.createdAt)).slice(0,n)},add:async(n,e,t=null,r={})=>{await Ia(Oe(H,"news"),{type:n,userId:e,targetId:t,createdAt:new Date().toISOString(),...r})}},Bc=[{name:"Toongod",url:"https://www.toongod.org/",desc:"18+"},{name:"Hentai20",url:"https://hentai20.io/",desc:"18+"},{name:"AllHen",url:"https://20.allhen.online/",desc:"18+"},{name:"Desu",url:"https://desu.uno/",desc:"18+"},{name:"HentaiChan",url:"https://hentaichan.live/",desc:"18+"},{name:"imhentai",url:"https://imhentai.xxx/",desc:"18+"}],Qv={all:()=>{try{const n=JSON.parse(localStorage.getItem("mdb_top_sites_v2"));return n!=null&&n.length?n:Bc}catch{return Bc}},save:n=>localStorage.setItem("mdb_top_sites_v2",JSON.stringify(n))},fr={};let Eo=null;function vt(n,e){fr[n]=e}function me(n){window.location.hash=n}function Yv(n){Eo=n}function Jv(){function n(){const e=window.location.hash.replace("#","")||"home";Eo&&Eo(e);let t=!1;for(const r of Object.keys(fr)){const s=[],i=r.replace(/:([^/]+)/g,(u,d)=>(s.push(d),"([^/]+)")),a=new RegExp(`^${i}$`),l=e.match(a);if(l){const u={};s.forEach((d,p)=>{u[d]=decodeURIComponent(l[p+1])}),fr[r](u),t=!0;break}}!t&&fr.home&&fr.home({})}window.addEventListener("hashchange",n),n()}function Xv(n){return`${n.toLowerCase().replace(/[^a-z0-9]/g,"_")}@manhwadb.app`}async function Zv(n,e,t=""){if(!n||n.trim().length<3)return{error:"Ім'я користувача має бути мінімум 3 символи"};if(!/^[a-zA-Z0-9_а-яА-ЯіІїЇєЄ]+$/.test(n))return{error:"Логін може містити лише літери, цифри та _"};if(!e||e.length<6)return{error:"Пароль має бути мінімум 6 символів"};if((await Xe(ie(H,"usernames",n.toLowerCase()))).exists())return{error:"Такий логін вже зайнятий. Оберіть інший."};const s=Xv(n);let i;try{i=await bm($t,s,e)}catch(u){return u.code==="auth/email-already-in-use"?{error:"Такий логін вже зайнятий."}:{error:u.message}}const a=i.user.uid,l=new Date().toISOString();return await zs(ie(H,"users",a),{username:n.trim(),email:t||"",bio:"",avatarBase64:"",top4:[null,null,null,null],createdAt:l}),await zs(ie(H,"usernames",n.toLowerCase()),{uid:a,internalEmail:s}),{user:{id:a,username:n.trim()}}}async function ew(n,e){if(!n||!e)return{error:"Заповніть всі поля"};const t=await Xe(ie(H,"usernames",n.toLowerCase()));if(!t.exists())return{error:"Користувача не знайдено"};const{internalEmail:r}=t.data();try{return{user:(await Am($t,r,e)).user}}catch(s){return s.code==="auth/wrong-password"||s.code==="auth/invalid-credential"?{error:"Невірний пароль"}:{error:s.message}}}async function tw(){await Dm($t)}async function nw(n,e,t){const r=$t.currentUser;if(!r)return{error:"Не авторизовано"};if(t.length<6)return{error:"Новий пароль має бути мінімум 6 символів"};try{const s=Mt.credential(r.email,e);return await Ru(r,s),await Rm(r,t),{ok:!0}}catch(s){return s.code==="auth/wrong-password"||s.code==="auth/invalid-credential"?{error:"Старий пароль невірний"}:{error:s.message}}}async function rw(n){const e=$t.currentUser;if(!e)return{error:"Не авторизовано"};try{const t=Mt.credential(e.email,n);return await Ru(e,t),await Vm(e),{ok:!0}}catch(t){return t.code==="auth/wrong-password"||t.code==="auth/invalid-credential"?{error:"Невірний пароль"}:{error:t.message}}}function rn(n){if(!n)return"";const e=Date.now(),t=new Date(n).getTime(),r=Math.floor((e-t)/1e3);return r<60?"щойно":r<3600?`${Math.floor(r/60)} хв тому`:r<86400?`${Math.floor(r/3600)} год тому`:r<86400*30?`${Math.floor(r/86400)} д тому`:new Date(n).toLocaleDateString("uk-UA",{day:"numeric",month:"short",year:"numeric"})}function Ta(n){return n?new Date(n).toLocaleDateString("uk-UA",{day:"numeric",month:"long",year:"numeric"}):""}function q(n){return(n||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Io(n,e=700,t=.65){return new Promise((r,s)=>{const i=new FileReader;i.onload=a=>{const l=new Image;l.onload=()=>{const u=document.createElement("canvas");let d=l.width,p=l.height;d>e&&(p=Math.round(p*e/d),d=e),u.width=d,u.height=p,u.getContext("2d").drawImage(l,0,0,d,p),r(u.toDataURL("image/jpeg",t))},l.onerror=s,l.src=a.target.result},i.onerror=s,i.readAsDataURL(n)})}function sw(n){return Io(n,200,.7)}function Vt(n,e=!1){if(e)return`<div class="crosses-display">${Array(10).fill('<span class="cross-mark">✕</span>').join("")}</div>`;const t=Math.floor(n),r=n%1>=.5,s=10-t-(r?1:0);let i='<div class="stars-display">';for(let a=0;a<t;a++)i+='<span class="star full"><svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></span>';r&&(i+='<span class="star half"><svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></span>');for(let a=0;a<s;a++)i+='<span class="star"><svg viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></span>';return i+="</div>",i}function Ke(n,e="md"){if(n&&n.avatarBase64)return`<img class="avatar avatar-${e}" src="${n.avatarBase64}" alt="${q(n.username)}">`;const t=n?(n.username||"?").charAt(0).toUpperCase():"?";return`<div class="avatar avatar-${e}">${t}</div>`}function Ve(n,e="info"){let t=document.querySelector(".toast-container");t||(t=document.createElement("div"),t.className="toast-container",document.body.appendChild(t));const r=document.createElement("div");r.className=`toast toast-${e}`;const s={success:"✅",error:"❌",info:"ℹ️"};r.innerHTML=`<span>${s[e]||""}</span><span>${q(n)}</span>`,t.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transition="opacity 0.3s",setTimeout(()=>r.remove(),300)},3500)}function qn(n){n.innerHTML='<div style="display:flex;justify-content:center;padding:80px"><div class="loader-spinner"></div></div>'}let Rs=null;function To(n="login"){Qt();const e=document.createElement("div");e.className="modal-backdrop",e.id="auth-modal",e.innerHTML=`
    ...
    </div>`,document.getElementById("back-btn").addEventListener("click",()=>history.back()),document.getElementById("cancel-review-btn").addEventListener("click",()=>history.back());const l=document.getElementById("cover-upload-area"),u=document.getElementById("cover-file"),d=document.getElementById("cover-actions");function p(){const x=l.querySelector("#cover-preview-img"),F=l.querySelectorAll("span:not(.upload-overlay span)");if(s){if(x)x.src=s;else{const M=document.createElement("img");M.id="cover-preview-img",M.src=s;const z=l.querySelector(".upload-overlay");l.insertBefore(M,z)}F.forEach(M=>M.remove()),d.style.display="flex"}else if(x&&x.remove(),d.style.display="none",!l.querySelector("span:not(.upload-overlay span)")){const M=document.createElement("span");M.style.fontSize="32px",M.textContent="🖼️";const z=document.createElement("span");z.textContent="Натисніть або перетягніть файл",l.appendChild(M),l.appendChild(z)}}l.addEventListener("click",()=>u.click()),u.addEventListener("change",async()=>{const x=u.files[0];x&&(s=await Io(x,700,.65),p())}),document.getElementById("remove-cover-btn").addEventListener("click",x=>{x.stopPropagation(),s="",p()}),l.addEventListener("dragover",x=>{x.preventDefault(),l.style.borderColor="var(--accent)"}),l.addEventListener("dragleave",()=>{l.style.borderColor=""}),l.addEventListener("drop",async x=>{x.preventDefault(),l.style.borderColor="";const F=x.dataTransfer.files[0];F!=null&&F.type.startsWith("image/")&&(s=await Io(F,700,.65),p())});const g=document.getElementById("review-status"),T=document.getElementById("rating-slider"),w=document.getElementById("stars-preview"),S=document.getElementById("rating-label");g.addEventListener("change",()=>{a=g.value;const x=a==="dropped",F=a==="planned";T.disabled=x||F,F?(w.innerHTML='<span style="color:var(--text-muted);font-size:0.9rem">Ще не оцінено</span>',S.textContent="-"):(w.innerHTML=Vt(x?0:i,x),S.textContent=x?"Кинута":i+"/10")}),T.addEventListener("input",()=>{i=parseFloat(T.value),w.innerHTML=Vt(i,!1),S.textContent=i+"/10"});const D=document.getElementById("save-review-btn");D.addEventListener("click",async()=>{const x=document.getElementById("review-title").value.trim(),F=document.getElementById("review-date").value,M=document.getElementById("review-tags").value,z=document.getElementById("review-text").value.trim(),ye=g.value,te=ye==="dropped"||ye==="planned"?0:i,E=M.split(",").map(v=>v.trim()).filter(Boolean),m=document.getElementById("review-form-error");if(!x){m.textContent="Назва обов'язкова",m.style.display="block";return}D.disabled=!0,D.textContent="Збереження...";const _={title:x,coverBase64:s,text:z,rating:te,status:ye,tags:E,date:F};try{let v;r?(v=await Ue.update(n,_),Ve("Рецензію оновлено ✅","success")):(v=await Ue.create(e.id,_),await nn.add("review",e.id,v.id,{username:e.username,extra:x}),Ve("Рецензію опубліковано! 📝","success")),me(`review/${v.id}`)}catch(v){m.textContent="Помилка: "+v.message,m.style.display="block",D.disabled=!1,D.textContent=D.dataset.label}})}async function _n(){const n=Re.currentUser();if(!n){me("home");return}const e=document.getElementById("page-root");qn(e);const[t,r,s]=await Promise.all([Le.ofUser(n.id),Le.pendingFor(n.id),Le.sentBy(n.id)]),i=async w=>{const S=w.requesterId===n.id?w.receiverId:w.requesterId,D=await ue.byId(S);return{...w,otherUser:D,otherId:S}},[a,l,u]=await Promise.all([Promise.all(t.map(i)),Promise.all(r.map(async w=>{const S=await ue.byId(w.requesterId);return{...w,otherUser:S}})),Promise.all(s.map(async w=>{const S=await ue.byId(w.receiverId);return{...w,otherUser:S}}))]);e.innerHTML=`
    ...
    </div>`;const d=document.getElementById("friend-search-btn"),p=document.getElementById("friend-search-input"),g=document.getElementById("friend-search-result"),T=async()=>{var x;const w=p.value.trim();if(!w)return;d.disabled=!0,d.textContent="...";const S=await ue.byUsername(w);if(d.disabled=!1,d.textContent="Знайти",!S||S.id===n.id){g.innerHTML='<div style="color:var(--text-muted);font-size:0.875rem">Користувача не знайдено</div>';return}const D=await Le.between(n.id,S.id);let k="";D?D.status==="pending"?k='<span class="friend-status friend-pending">Запит надіслано</span>':k='<span class="friend-status friend-accepted">Вже друзі ✅</span>':k=`<button class="btn btn-primary btn-sm" id="add-friend-btn" data-uid="${S.id}">➕ Надіслати запит</button>`,g.innerHTML=`<div class="friend-item">
      ${Ke(S,"sm")}
      <div class="friend-info"><div class="friend-name">${q(S.username)}</div></div>
      ${k}
    </div>`,(x=document.getElementById("add-friend-btn"))==null||x.addEventListener("click",async()=>{await Le.send(n.id,S.id),await nn.add("friend",n.id,S.id,{username:n.username}),Ve(`Запит надіслано ${S.username}`,"success"),await _n()})};d.addEventListener("click",T),p.addEventListener("keydown",w=>{w.key==="Enter"&&T()}),e.querySelectorAll("[data-accept]").forEach(w=>{w.addEventListener("click",async()=>{const S=w.dataset.accept;await Le.accept(S,n.id);const D=await ue.byId(S);await nn.add("friend",n.id,S,{username:n.username,friendName:(D==null?void 0:D.username)||"Unknown"}).catch(console.error),Ve("Запит прийнято ✅","success"),await _n()})}),e.querySelectorAll("[data-decline]").forEach(w=>{w.addEventListener("click",async()=>{await Le.remove(w.dataset.decline,n.id),await _n()})}),e.querySelectorAll("[data-cancel]").forEach(w=>{w.addEventListener("click",async()=>{await Le.remove(n.id,w.dataset.cancel),await _n()})}),e.querySelectorAll("[data-remove]").forEach(w=>{w.addEventListener("click",async()=>{window.confirm("Видалити зі списку друзів?")&&(await Le.remove(n.id,w.dataset.remove),Ve("Видалено зі списку друзів","info"),await _n())})}),e.querySelectorAll("[data-profile], [data-view-profile]").forEach(w=>{w.addEventListener("click",()=>me(`profile/${w.dataset.profile||w.dataset.viewProfile}`))})}async function aw(){const n=Re.currentUser();if(!n){me("home");return}await On(n.id,!0)}async function On(n,e=!1){var l,u,d,p;const t=document.getElementById("page-root");qn(t);const[r,s]=await Promise.all([ue.byId(n),Ue.byUser(n)]);if(!r){t.innerHTML='<div class="page-container"><div class="empty-state"><div class="empty-icon">😕</div><h3>Користувача не знайдено</h3></div></div>';return}const i=r.top4||[null,null,null,null],a=await Promise.all(i.map(g=>g?Ue.byId(g):Promise.resolve(null)));if(t.innerHTML=`
    <div class="page-container">
      <!-- Profile Header -->
    ...
    </div>`;const s=()=>r.innerHTML="";document.getElementById("top4-modal-close").addEventListener("click",s),document.getElementById("top4-modal").addEventListener("click",i=>{i.target.id==="top4-modal"&&s()}),document.getElementById("top4-search").addEventListener("input",i=>{const a=i.target.value.toLowerCase();r.querySelectorAll("[data-pick-review]").forEach(l=>{l.style.display=!a||l.title.toLowerCase().includes(a)?"":"none"})}),r.querySelectorAll("[data-pick-review]").forEach(i=>{i.addEventListener("click",async()=>{const a=await ue.byId(n),l=[...a.top4||[null,null,null,null]];l[e]=i.dataset.pickReview,await ue.save({...a,top4:l}),s(),await On(n,!0)})})}async function Ao({id:n}){var t,r;const e=Re.currentUser();if(e&&e.id===n){me("account");return}if(await On(n,!1),e&&document.querySelector(".profile-info")){const i=await Le.between(e.id,n);let a="";i?i.status==="pending"?i.requesterId===e.id?a='<button class="btn btn-secondary btn-sm" disabled>⏳ Запит надіслано</button>':a='<button class="btn btn-primary btn-sm" id="accept-friend-profile-btn">✅ Прийняти запит</button>':a='<button class="btn btn-secondary btn-sm" disabled>✅ Друзі</button>':a='<button class="btn btn-primary btn-sm" id="add-friend-profile-btn">➕ Додати в друзі</button>';const l=document.getElementById("friend-btn-area");l&&(l.style.marginTop="12px",l.innerHTML=a),(t=document.getElementById("add-friend-profile-btn"))==null||t.addEventListener("click",async()=>{await Le.send(e.id,n),await nn.add("friend",e.id,n,{username:e.username}),Ve("Запит надіслано!","success"),await Ao({id:n})}),(r=document.getElementById("accept-friend-profile-btn"))==null||r.addEventListener("click",async()=>{await Le.accept(n,e.id);const u=await ue.byId(n);await nn.add("friend",e.id,n,{username:e.username,friendName:(u==null?void 0:u.username)||"Unknown"}).catch(console.error),Ve("Тепер ви друзі ✅","success"),await Ao({id:n})})}}async function Ro({id:n}){var S,D,k,x,F;const e=document.getElementById("page-root");qn(e);const[t,r]=await Promise.all([Ue.byId(n),Promise.resolve(Re.currentUser())]);if(!t){e.innerHTML='<div class="page-container"><div class="empty-state"><div class="empty-icon">😕</div><h3>Рецензія не знайдена</h3></div></div>';return}const s=await ue.byId(t.userId),i=r&&r.id===t.userId,a=t.status==="dropped",l=t.status==="planned",u={done:"✅ Завершено",reading:"📖 Читаю",planned:"⏳ В планах",dropped:"❌ Кинув"},d={done:"status-done",reading:"status-reading",planned:"status-planned",dropped:"status-dropped"},p=t.likes||[],g=t.dislikes||[],T=r&&p.includes(r.id),w=r&&g.includes(r.id);e.innerHTML=`
  ...
  ${r.map(u=>{const d=u.likes||[],p=u.dislikes||[],g={username:u.username,avatarBase64:u.avatarBase64};return`<div class="comment-item reply">
    ...
    </div>`}).join("")}let So=!1;function pw(){const n=document.getElementById("app");n.innerHTML="";const e=document.createElement("div");e.id="page-root",n.appendChild(e),Yv(()=>{bo(),window.scrollTo({top:0,behavior:"smooth"})}),vt("home",()=>iw()),vt("new-review",()=>{if(!Re.currentUser()){ms(()=>Promise.resolve().then(()=>Ss),void 0,import.meta.url).then(t=>t.showAuthModal("login")),window.location.hash="home";return}qc(null)}),vt("edit-review/:id",({id:t})=>{if(!Re.currentUser()){window.location.hash="home";return}qc(t)}),vt("friends",()=>{if(!Re.currentUser()){ms(()=>Promise.resolve().then(()=>Ss),void 0,import.meta.url).then(t=>t.showAuthModal("login")),window.location.hash="home";return}_n()}),vt("account",()=>{if(!Re.currentUser()){ms(()=>Promise.resolve().then(()=>Ss),void 0,import.meta.url).then(t=>t.showAuthModal("login")),window.location.hash="home";return}aw()}),vt("profile/:id",({id:t})=>Ao({id:t})),vt("review/:id",({id:t})=>Ro({id:t})),vt("all-reviews/:userId",({userId:t})=>fw({userId:t})),bo(),So||(Jv(),So=!0)}km($t,async n=>{if(n){const e=await ue.byId(n.uid);Re.setProfile(e?{...e,id:n.uid}:{id:n.uid,username:n.displayName||"User"})}else Re.setProfile(null);So?bo():pw()});
